  ...
  return `<div class="announcement"><span class="announcement-desktop">Sua rotina de beleza começa aqui <span aria-hidden="true">✦</span> Catálogo demonstrativo</span><span class="announcement-mobile">Marquesa · catálogo demonstrativo</span></div>
    <header class="site-header">
      <div class="container header-inner">
        ...
        <a class="brand" href="#/" aria-label="Marquesa, voltar ao início"><img src="./assets/marquesa-logo-horizontal.webp" alt="Marquesa — A Loja da Beleza" /><span class="brand-wordmark" aria-hidden="true"><strong>Marquesa</strong><small>A Loja da Beleza</small></span></a>
...
function home() {
  ...
  return `<main id="main-content" data-view="home">
    <section class="hero"><div class="container hero-inner"><div class="hero-content"><span class="eyebrow hero-eyebrow"><span aria-hidden="true">✦</span> Curadoria Marquesa <span aria-hidden="true">✦</span></span><h1>O seu ritual.<br /><em>A sua presença.</em></h1><p>Produtos escolhidos para transformar o cuidado de todos os dias em um momento só seu.</p><div class="hero-actions"><a class="button button-primary" href="#/catalogo">Encontrar meus favoritos ${icon('arrow')}</a><a class="button button-outline" href="#/catalogo?categoria=Maquiagem">Ver maquiagem</a></div><div class="hero-proof"><span><strong>+</strong> 12</span><small>achados para descobrir</small><span><strong>✦</strong> seu momento</span></div></div><div class="hero-visual"><img src="./assets/hero-beleza.webp" alt="Composição editorial de produtos de beleza em tons de rosa e dourado" /><span class="hero-badge">Beleza<br /><em>com presença</em></span></div></div></section>
