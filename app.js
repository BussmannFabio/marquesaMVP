...
function home() {
  ...
  return `<main id="main-content" data-view="home">
    <section class="hero"><div class="hero-media"><picture><source media="(max-width: 599px)" srcset="./assets/hero-marquesa-mobile.webp" /><img src="./assets/hero-marquesa-campanha.webp" alt="Retrato editorial de mulher com maquiagem suave em tons de rosa e roxo" width="1672" height="941" fetchpriority="high" /></picture></div><div class="container hero-inner"><div class="hero-content"><span class="eyebrow">Beleza com um toque de realeza</span><h1>Seu brilho<br /><em>é só seu.</em></h1><p>Da rotina ao toque final, encontre produtos para viver a beleza do seu jeito.</p><div class="hero-actions"><a class="button button-primary" href="#/catalogo">Explorar produtos ${icon('arrow')}</a><a class="hero-secondary" href="#/catalogo?categoria=Maquiagem">Descobrir maquiagem ${icon('arrow')}</a></div></div></div></section>
