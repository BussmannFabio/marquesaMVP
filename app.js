...
function home() {
  ...
  return `<main id="main-content" data-view="home">
    <section class="hero"><div class="container hero-inner"><div class="hero-content"><span class="eyebrow">A Loja da Beleza</span><h1>Sua beleza.<br /><em>Seu momento.</em><br />Sua Marquesa.</h1><p>Descubra uma seleção pensada para deixar cada ritual de cuidado ainda mais seu.</p><div class="hero-actions"><a class="button button-primary" href="#/catalogo">Explorar produtos ${icon('arrow')}</a><a class="button button-outline" href="#/catalogo?categoria=Maquiagem">Descobrir maquiagem</a></div><span class="hero-note">Beleza com um toque de realeza</span></div><div class="hero-visual"><img src="./assets/hero-beleza.webp" alt="Composição editorial ilustrativa de produtos de beleza em tons suaves" /></div></div></section>
